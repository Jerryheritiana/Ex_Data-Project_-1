...
## Ploting for plot in one files

png(filename = "Plot 4.png")
par(mfrow = c(2, 2))

## plot Time with global active power
with(data, plot(Ftime, Global_active_power, type ="l",xaxt = "n" ,xlab = " ", ylab="Global Active Power "))
## x- axis units
...
### Plot Voltage
with(data, plot(Ftime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage", xaxt ="n"))
axis(1, at = axis_unit , labels = format(axis_unit, format = "%a"))

### Plot Energy sub metering
with(data, plot(Ftime, Sub_metering_1, col = "black", type ="l", xaxt = "n", ylab = "Energy Sub Metering", xlab = " ")) ## Sub_metering_1 
lines(data$Ftime, data$Sub_metering_2, col = "red", type = "l", xaxt = "n") ## Sub_metering_2
lines(data$Ftime, data$Sub_metering_3, col ="blue", type ="l", xaxt = "n") ## Sub_metering_3
axis(1, at = axis_unit , labels = format(axis_unit, format = "%a"))
#### legend
legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, bty = "n")

### Plot Global_relative_power
with(data, plot (Ftime, Global_reactive_power, xaxt = "n", xlab = "datetime", ylab = "Global_reactive_power", type = "l"))
axis_unit <- as.POSIXct(axis_unit)
axis(1, at = axis_unit , labels = format(axis_unit, format = "%a"))
